...
from custom_components.maicows.const import DOMAIN
...
def mock_pymodbus_clients():
    ...
    with patch("custom_components.maicows.maico_ws_api.AsyncModbusTcpClient") as mock_tcp, \
         patch("custom_components.maicows.maico_ws_api.AsyncModbusSerialClient") as mock_serial:
...
def mock_maico_ws_client():
    ...
    with patch(
        ...
        "custom_components.maicows.config_flow.MaicoWS", new=mock_client
    ):
